function openPage(pageName) 
{
    ...
    document.getElementById("SearchPr").style.display = "none";
...
function popularity(pageName) 
{
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState === XMLHttpRequest.DONE && this.status === 500) {
            ...
            document.getElementById("PopS").innerHTML = this.responseText;
        }
    }

    var formData = new FormData();

    formData.append("type", 'PopS');

    xhr.send(formData);
}

function prepping(pageName) 
{
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/feedPage.html", true);
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState === XMLHttpRequest.DONE && this.status === 500) {
            ...
            //stergem ce era initial
            document.getElementById("PrepS").innerHTML = '';

            document.getElementById("PrepS").innerHTML = this.responseText;
        }
    }

    var formData = new FormData();

    formData.append("type", 'PrepS');

    xhr.send(formData);
}

function final(pageName) 
{
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/feedPage.html", true);
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState === XMLHttpRequest.DONE && this.status === 500) {
            ...
            document.getElementById("FinalS").innerHTML = this.responseText;
        }
    }

    var formData = new FormData();

    formData.append("type", 'FinalS');

    xhr.send(formData);
}

function diff(pageName) 
{
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "/feedPage.html", true);
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState === XMLHttpRequest.DONE && this.status === 500) {
            ...
            document.getElementById("DiffS").innerHTML = this.responseText;
        }
    }
