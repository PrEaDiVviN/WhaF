...
module.exports = class recipePageController {
    static async GET(request, response) {
        ...
        pageName = pageName.replace('%20',' ').replace('%20',' ').replace('%20',' ');
        ...
        if(exists != null) { //daca exista, atunci construim view-ul
            ...
            const recipePhoto =  '/recipes/' + pageName.replace('%20', ' ').replace('%20',' ').replace('%20',' ') + '/' + 'recipePhoto.jpg' + '?' + new Date().getTime();
